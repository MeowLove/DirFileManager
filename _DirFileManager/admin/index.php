...
$GLOBALS['exclude_items'] = $dfm_ignore;

// Docs Viewer (Google/Microsoft)
...
if (isset($_GET['view'])) {
    ...
    <div class="row">
        <div class="col-12">
            ...
            if($is_onlineViewer) {
                if($dfm_function['docs_viewer'] == 'Google')
                {
                // Google Docs viewer
                echo '<iframe src="https://docs.google.com/viewer?embedded=true&hl=en&url=' . fm_enc($file_url) . '" frameborder="no" style="width:100%;min-height:460px"></iframe>';
                }
                elseif($dfm_function['docs_viewer'] == 'Microsoft')
                {
                // Microsoft Docs viewer
                echo '<iframe src="https://view.officeapps.live.com/op/view.aspx?src=' . fm_enc($file_url) . '" frameborder="no" style="width:100%;min-height:460px"></iframe>';
                }
            } elseif ($is_zip) {
                // ZIP content
                if ($filenames !== false) {
...
<head>
    ...
    <meta name="description" content="Dir File Manager - File Management Panel">
    <meta name="author" content="https://github.com/MeowLove/DirFileManager">
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <link rel="icon" href="<?php echo $root_url ?>?img=favicon" type="image/png">
    <title>Login - Dir File Manager - File Management Panel</title>
...
<head>
    ...
    <meta name="googlebot" content="noindex">
    <link rel="icon" href="<?php echo $root_url ?>?img=favicon" type="image/png">
    <title>Dir File Manager - File Management Panel</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css">
...
function lng($txt) {
    ...
    $tr['en']['FreeOf']         = 'Free Of';                $tr['en']['FullSize']           = 'Full Size';
    $tr['en']['Zip']            = 'Zip';                    $tr['en']['Tar']                = 'Tar';
